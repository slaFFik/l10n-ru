...
<!-- You can start editing here. -->
	...
	<?php if ('open' == $post->comment_status) : ?>
		...
		<?php else : ?>
			...
			<?php if ( isset($_GET['edit_comments_xt']) ) : $edit_comment_xt = edit_comments_xt_init(); if (!$edit_comment_xt) : return; endif; elseif ( $user_ID ) : ?>
			...
			<p><textarea name="comment" id="comment" cols="100%" rows="10" tabindex="4"><?php if (function_exists('edit_comments_xt_content')) edit_comments_xt_content($edit_comment_xt); ?></textarea></p>
