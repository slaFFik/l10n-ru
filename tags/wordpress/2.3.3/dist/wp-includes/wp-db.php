...
<p>Мы соединились с сервером базы данных (это значит, что имя и пароль правильные), но мы не можем выбрать базу <code>$db</code>.</p>
<ul>
<li>Вы уверены, что она существует?</li>
<li>Есть ли у пользователя <code>".DB_USER."</code> права доступа к базе данных <code>$db</code>?</li>
